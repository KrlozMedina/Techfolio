...
const sections = [
  { href: '/profile/about-me', label: 'Sobre mí' },
  { href: '/profile/education', label: 'Educación' },
  { href: '/profile/skills', label: 'Habilidades' },
  { href: '/profile/certifications', label: 'Certificaciones' },
  { href: '/profile/experience', label: 'Experiencia laboral' },
  { href: '/profile/achievements', label: 'Logros' },
];
  ...
  return (
    <section className={style.profile}>
      <header className={style.header}>
        ...
        <p>
          Aquí encontrarás información sobre mi formación, experiencia y habilidades.
        </p>
      </header>
