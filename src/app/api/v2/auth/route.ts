...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    role: session.role, // ⚠️ ahora obligatorio
  });
}
...
export async function POST(req: NextRequest) {
  try {
     ...
     * loginUser DEBE:
     * - validar password
     * - obtener role desde backend
     * - devolver token firmado con role
     */
...
export async function DELETE() {
  ...
  // ⚠️ Aquí debería revocarse el jti si existe
