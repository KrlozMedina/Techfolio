      ...
      <section className='section-text'>
        ...
        <span className="text__title">
          <MdOutlineWorkOutline /> {
            t.about.professionalExperienceTitle
        ...
        <ul className='text'>
          <li>
            <u>{t.about.values.respect}</u>
            {/* <u>Respeto</u> */}
            {
              t.about.valuesDescription.respect
              // isSpanish
          ...
          <li>
            <u>{t.about.values.trust}</u>
            {
              t.about.valuesDescription.trust
              // isSpanish
          ...
          <li>
            <u>{t.about.values.loyalty}</u>
            {
              t.about.valuesDescription.loyalty
              // isSpanish
