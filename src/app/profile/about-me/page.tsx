  ...
  return (
    <>
      ...
      <section className='section-text'>
        ...
        <ul className='text'>
          <li>
            <u>{t.about.values.items.respect}</u>
            {/* <u>Respeto</u> */}
            {
              t.about.values.list.respect
              // isSpanish
          ...
          <li>
            <u>{t.about.values.items.trust}</u>
            {
              t.about.values.list.trust
              // isSpanish
          ...
          <li>
            <u>{t.about.values.items.loyalty}</u>
            {
              t.about.values.list.loyalty
              // isSpanish
